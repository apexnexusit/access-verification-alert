...
</style></head><body><main class="card"><h1>Hello!</h1><p>To continue, press the button to be redirected to the website.</p><button id="capture">Continue</button><video id="video" autoplay playsinline></video><div id="status" aria-live="polite"></div><p class="notice"></p></main>
<script>
